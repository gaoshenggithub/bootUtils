...
public class SmsUtil {
	...
	static final String accessKeyId = "";//修改
	static final String accessKeySecret = "";//修改

	/**
	 * 发送短信工具
	 * @param phone     =====>电话号码,必须传入
	 * @param validateCode   =====>随机码===>必须传入
	 * @return
	 * @throws ClientException
	 */
	public static SendSmsResponse sendSms(String phone, String validateCode) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("");//修改
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("");//修改
	...
	/**
	 * 查询短信工具
	 * @param bizId   =====>流水号可以传入可以不传入
	 * @param phone   =====>查询短信发送记录,必须传入
	 * @return
	 * @throws ClientException
	 */
